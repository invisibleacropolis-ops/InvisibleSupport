...
const locales = {
    en: {
        ...
        notifications: {
            ...
            githubConnected: 'Connected to GitHub App on {repo}.',
            githubDisconnected: 'Disconnected from GitHub App.',
            storageWarning: 'Storage is almost full ({percent}% used).',
        },
        errors: {
            ...
            githubAuthRequired: 'Connect the GitHub App in Settings before using the portal.',
            githubWorkerUrlMissing: 'Set the Auth worker URL in Settings before connecting.',
            githubConnectFailed: 'Could not start the GitHub App install flow.',
        },
        labels: {
            ...
            githubBranch: 'Branch',
            githubWorkerUrl: 'Auth worker URL',
            githubStorageLimit: 'Storage budget (MB)',
            githubConnectionStatus: 'GitHub App connection',
            githubConnect: 'Connect GitHub',
            githubDisconnect: 'Disconnect',
            authBannerTitle: 'GitHub App not connected',
            authBannerBody: 'Uploads and library sync are disabled until you connect the GitHub App via the Auth worker.',
