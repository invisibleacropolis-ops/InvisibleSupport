...
const locales = {
    en: {
        ...
        notifications: {
            ...
            supabaseTestSuccess: 'Connection to Supabase succeeded.',
            supabaseTestFailure: 'Supabase connection failed. Check the project setup and sign-in state.',
            supabaseMagicLinkSent: 'Magic link sent. Check your email to sign in.',
            supabaseSignedOut: 'Signed out of Supabase.',
        },
        errors: {
            ...
            supabaseConfigMissing: 'Configure the Supabase project URL and publishable key before uploading.',
            supabaseRequestFailed: 'Supabase request failed. Review the setup instructions and try again.',
            supabaseAuthRequired: 'Sign in with Supabase before using the portal.',
        },
        labels: {
            storageUsed: 'Storage used',
            storageAvailable: 'Portal upload limit',
            storageDocuments: 'Documents',
            storageImages: 'Images',
            storageDocumentSingular: 'Document',
            storageImageSingular: 'Image',
            storageLimitUnset: 'No portal limit',
            storageDialogTitle: 'Storage management',
            storageDialogDescription:
                'Review the items currently stored in Supabase. The portal does not impose an upload or storage limit.',
            ...
            supabaseEmail: 'Email address',
            supabaseConnectionStatus: 'Supabase session',
            supabaseSendMagicLink: 'Send magic link',
            supabaseSignOut: 'Sign out',
        ...
        upload: {
            ...
            errorMissingConfiguration: 'Configure Supabase and sign in before uploading.',
        },
        gallery: {
